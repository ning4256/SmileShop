...
public class SendMail { 
	//发送的邮箱地址（该邮件由谁发送）
	public final static String sender ="434962239@qq.com";
	//授权码（钥匙），有了钥匙邮件系统才能知道你是有权限用该邮箱发送邮件的
	public final static String key="yemfjmqaowyacbdj";
	public static void main(String[] args){       
		try {
			new SendMail().send("434962239@qq.com", "邮件测试", "你已经成功购买了GirlCloset中的商品！");
